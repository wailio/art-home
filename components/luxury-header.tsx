      ...
      <div className={`border-b border-black/5 transition-colors duration-300 ${mainBarClass}`}>
        <div className="mx-auto flex h-[100px] max-w-7xl items-center justify-between px-8">
          ...
          <Link href="/" className="group absolute left-1/2 -translate-x-1/2">
            <Image src={isHomePage ? "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/whiteart-gxfxsgTdkvrIAsARC5BZmPl6t2raUv.png" : "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/ChatGPT%20Image%206%20sept.%202026%2C%2014_13_18-JKCNNNWk9NEpwDsRXjO1QIuzRA1eC3.png"} alt="ArtHome" width={1254} height={1016} className="h-28 w-auto object-contain transition-transform duration-300 group-hover:scale-105" />
          </Link>
